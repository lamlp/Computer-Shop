<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Web_j.Index" %>
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" Width="100%" OnItemCommand="DataList1_ItemCommand" DataKeyField="ProductID">
        ...
        <%--<div class="s-12 m-6 l-4">--%>
                    ...
                    <asp:LinkButton ID="lbtProductName" runat="server" Text='<%# Eval("ProductName") %>'
                        PostBackUrl='<%# "ProductDetail.aspx?ProductID="+ Eval("ProductID") %>' 
                        ...
                        Font-Underline="True" ForeColor="#0066FF"></asp:LinkButton> 
                           ...
                           <div>
                               <asp:Button ID="Button1" runat="server" Cssclass="button rounded-btn submit-btn s-12" CommandName="GioHang" Text="Add to cart" />
                           </div>
                     <%--</div>   --%>                              
        </ItemTemplate>
    </asp:DataList>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="recomd">
